...
def get_selective_search_regions(img, scale=500, min_felzenszwalb_size=10, min_region_size=100):
    '''Perform Selective Search and filter regions
    ...
    ----------
        ...
        min_felzenszwalb_size : int
            Minimum component size for felzenszwalb segmentation.
        min_region_size: int
            Minimum size for final regions
    Returns
    -------
        regions : array of tuples
            [
                 (x, y, width, height),
                 ...
            ]
